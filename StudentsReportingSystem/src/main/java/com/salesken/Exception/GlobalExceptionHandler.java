...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<MyErrorDetails> SemesterExceptionHandler(SemesterException me, WebRequest re) {
	...
	public ResponseEntity<MyErrorDetails> StudentExceptionHandler(StudentException me, WebRequest re) {
		MyErrorDetails err = new MyErrorDetails();
		err.setTimestamp(LocalDateTime.now());
		err.setMessage(me.getMessage());
		err.setDescription(re.getDescription(false));
